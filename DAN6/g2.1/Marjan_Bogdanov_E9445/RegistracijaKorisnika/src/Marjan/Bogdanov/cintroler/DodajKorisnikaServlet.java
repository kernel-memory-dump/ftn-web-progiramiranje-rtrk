package Marjan.Bogdanov.cintroler;
...
public class DodajKorisnikaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Ime osove je:" + ime + "tip:" + tip);
	...
	/**
	 * Generise odgovor za klijensta, spisak korisnika
	 * @param users - ovo je lista korisnika za ispis unutar <ol> na klijentu
