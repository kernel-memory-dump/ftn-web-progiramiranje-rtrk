...
import una.radosavac.dao.UserDao;
...
public class DodajKorisnikaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			printer.print("<html><body><h1> NEUSPJESNO DODAVANJE KORISNIKA! GRESKA! </h1></body></html>");
			printer.flush();
			printer.close();
			return;
		}
	...
	/**
	 * Generate page for client including a list of all users as
	 * <ol>
	 * 
	 * @param users
