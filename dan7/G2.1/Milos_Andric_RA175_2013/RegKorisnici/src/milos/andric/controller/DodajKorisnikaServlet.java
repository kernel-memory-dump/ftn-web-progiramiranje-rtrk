package milos.andric.controller;
...
import milos.andric.dao.UserDao;
import milos.andric.model.User;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		catch (IOException e)
		{
			printer.print("<html><body>"
					+ "<h1> Neuspesno dodavanje korisnika, desila se greska pri upisu novog korisnika.</h1>"
					+ "<body><html>");
			printer.flush();
			printer.close();
			return;
