...
import milan.ivankovic.dao.UserDao;
import milan.ivankovic.model.User;
...
public class DodajKorisnikaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			printer.print("<html><body><h1>Desila se greska pri dodavanju kosisnika</h1></body></html>");
			printer.flush();
			printer.close();
			return;
		}
	...
	/**
	 * Generates page for client uncluding a list of all users as <ol>
	 * @param users - List of currently registred users fetched from file
	 * @return HtML respons to be snet to the client
	 */
