package nemanja.pajic.controller;
...
import nemanja.pajic.dao.UserDao;
import nemanja.pajic.model.User;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			printer.print("<html><body>"
					+ "<h1>Neuspesno dodavanje korisnika, desila se greska pri upisu novog korisnika</h1></body></html>");
			printer.flush();
			printer.close();
			return;
		}
